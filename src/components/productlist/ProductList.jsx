...
const ProductList = () => {
    return (
        <main className="product-display">
            ...
            <ProductCard image ={"/assets/products/prod-1.jpg"}
                  title ={"Sangria"}
                  subtitle = {"Full Sleeve Padded Jacket"}
                  price = {"₹1,227"}
             />

            <ProductCard image ={"/assets/products/prod-2.jpg"}
                  title ={"Sangria"}
                  subtitle = {"Pink Georgette Ruffled Saree"}
                  price = {"₹1349"}
            />

            <ProductCard image ={"/assets/products/prod-3.jpg"}
                  title ={"Ahalyaa"}
            ...
            <ProductCard image ={"/assets/products/prod-4.jpg"}
                  title ={"Ira Soleil"}
                  subtitle = {"Pink & Gold-Coloured Ethnic Motifs Peplum Top"}
                  price = {"₹1199"}
                  
            />
            <ProductCard image ={"/assets/products/prod-5.jpg"}
                  title ={"Marie Claire"}
            ...
            <ProductCard image ={"/assets/products/prod-6.jpg"}
                  title ={"STREET 9"}
            ...
            <ProductCard image ={"/assets/products/prod-7.jpg"}
                  title ={"SASSAFRAS"}
            ...
            <ProductCard image ={"/assets/products/prod-8.jpg"}
                  title ={"Sangria"}
            ...
            <ProductCard image ={"/assets/products/prod-9.jpg"}
                  title ={"Suta"}
            ...
            <ProductCard image ={"/assets/products/prod-10.jpg"}
                  title ={"INDYA"}
            ...
            <ProductCard image ={"/assets/products/prod-11.jpg"}
                  title ={"Anouk"}
            ...
            <ProductCard image ={"/assets/products/prod-12.jpg"}
                  title ={"La Zoire"}
