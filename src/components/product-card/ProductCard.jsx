...
const Card = () =>{
    return (
        <div className="product-display-container">
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-2.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-3.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-4.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-5.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-6.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-7.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-8.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-9.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-10.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-11.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
            ...
            <div className="card vertical-card card-shadow">
                <figure className="card-header">
                    <img src="../assets/products/prod-12.jpg" alt="" />
                </figure>
                <button className="card-floating-icon">
                    <MdOutlineFavoriteBorder title="Add to Wishlist"/>
                </button>
